 ...
 * @author aburkholder
 */
public class RatingsSvcServiceException extends BipRuntimeException {
	 ...
	 */
	public RatingsSvcServiceException(final MessageKey key, final MessageSeverity severity, final HttpStatus status,
			final String... params) {
